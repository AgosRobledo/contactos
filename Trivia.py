...
def crear_ventana():
    ...
    def iniciar_juego():
        ...
        if nombre and apellido and telefono:
            jugadores_data.append((nombre, apellido, telefono))
...
# Título del formulario
    ...
    jugar_button = tk.Button(formulario_frame, text="SALIR", bg="#9E5B00", font=("Arial",8, 'bold'), command=lambda:salir())
...
def abrir_juego():
        ...
        def verificar_respuesta(opcion):
            ...
            mostrar_pregunta()
            if pregunta_actual < len(preguntas_respuestas):
                messagebox.showinfo("Resultado", mensaje)  # Usa messagebox de esta manera
            else:
...
#quieor que este botton me deje salir de la pantalla de las preguntas

#funcion para salir de root
root.mainloop()
abrir_juego()
